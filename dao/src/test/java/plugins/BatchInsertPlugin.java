...
import plugins.utils.ClassElementGeneratorUtil;

/**
 * Created by Jeff_xu on 2020/12/3. batchInsert 插件 条件： 1. Mybatis 版本大于等于1.3 2. 不能对参数设置别名，默认是 list 3. 设置 useGeneratedKeys="true" keyProperty="id" 用户主键 id 回写
 *
 * @author Jeff_xu
 */
